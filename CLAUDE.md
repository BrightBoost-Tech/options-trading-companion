...
- **Expiry-day thesis measurement resolves post-close.** The naturally
  ...
  date from the exact expiry-date close. A missing close remains typed
  unknown/partial; never defer a Friday expiry merely because
  `expiry == today`, and never fabricate a terminal price.
