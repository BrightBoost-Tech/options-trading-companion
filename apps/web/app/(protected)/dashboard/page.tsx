              ...
              <div className="px-6 py-4 border-b border-border flex justify-between items-center">
                ...
                <div className="flex gap-2">
                  ...
                  <button
                    ...
                    className="text-xs px-3 py-1 rounded border border-purple-200 text-purple-700 hover:bg-purple-50 dark:border-purple-800 dark:text-purple-300 dark:hover:bg-purple-900/30"
                  >
                ...
                <div className="flex items-center gap-4">
                    <div className="flex items-center gap-2 bg-muted p-1 rounded-lg border border-border">
                         <button
                            ...
                            className={`px-3 py-1 text-xs font-medium rounded transition-colors ${simMode === 'deterministic' ? 'bg-card text-indigo-700 dark:text-indigo-300 shadow-sm border border-border' : 'text-muted-foreground hover:text-foreground'}`}
                         >
                            Deterministic
                         </button>
                         <button
                            onClick={() => setSimMode('random')}
                            className={`px-3 py-1 text-xs font-medium rounded transition-colors ${simMode === 'random' ? 'bg-card text-indigo-700 dark:text-indigo-300 shadow-sm border border-border' : 'text-muted-foreground hover:text-foreground'}`}
                         >
                            Random
                         </button>
                    </div>
