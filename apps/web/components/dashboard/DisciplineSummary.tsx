...
export default function DisciplineSummary({ className }: { className?: string }) {
    ...
    const progressColorClass = disciplinePct >= 80 ? '[&>div]:bg-green-600 dark:[&>div]:bg-green-500' : disciplinePct >= 50 ? '[&>div]:bg-yellow-600 dark:[&>div]:bg-yellow-500' : '[&>div]:bg-red-600 dark:[&>div]:bg-red-500';
