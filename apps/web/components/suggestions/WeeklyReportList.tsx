      ...
      >
        <div className="flex justify-between items-start mb-4 border-b border-gray-100 pb-2">
          ...
          <button
            ...
            className="text-xs flex items-center gap-1 text-gray-500 hover:text-gray-800 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gray-400 rounded px-1 -ml-1"
