...
class TestScheduledLocalTimeGate(unittest.TestCase):
    """Tests for --scheduled-local-time gate in check_time_gate."""
    ...
    def test_correct_season_passes(self, *_):
        ...
        self.assertTrue(check_time_gate("suggestions_close", scheduled_local_time="08:00"))
    ...
    def test_wrong_season_rejected(self, *_):
        ...
        self.assertFalse(check_time_gate("suggestions_close", scheduled_local_time="08:00"))
