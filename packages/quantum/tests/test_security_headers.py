...
def test_security_headers(monkeypatch):
    # The middleware snapshots APP_ENV at construction and emits HSTS only for
    # non-development. Pin development explicitly so the "no HSTS" assertion
    # below is deterministic regardless of ambient / sibling-test env leakage
    # (this file is a full-suite '[Cluster M] long tail' member).
